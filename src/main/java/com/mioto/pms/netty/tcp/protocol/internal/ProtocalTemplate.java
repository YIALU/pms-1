package com.mioto.pms.netty.tcp.protocol.internal;

import cn.hutool.core.io.resource.ResourceUtil;
import com.mioto.pms.netty.tcp.protocol.CodecConfig;
import com.mioto.pms.netty.tcp.protocol.internal.ConfigParse.Constants;
import com.mioto.pms.netty.tcp.protocol.internal.ConfigParse.FieldGroup;
import com.mioto.pms.netty.tcp.protocol.internal.ConfigParse.IFieldNode;
import com.mioto.pms.netty.tcp.protocol.internal.ConfigParse.LoadHelper;
...
public class ProtocalTemplate implements Constants {
    ...
    public void loadConfig(String protocalName) throws Exception{
        ...
        //加载文件
        InputStream stream=ResourceUtil.getStream(CONFIG_FILE);
